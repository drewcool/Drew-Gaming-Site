...
const Hero = () => {
  ...
  return (
    <div className='relative h-dvh w-screen overflow-x-hidden'>
      ...
      <div id='video-frame' className='relative overflow-hidden rounded-lg bg-blue-75 h-dvh w-screen z-10'>
        ...
        //TEXT
          ...
          <div className='absolute left-0 top-0 z-40'>
            <div className="mt-24 px-5 sm:px-10">
              <h1 className=" uppercase text-9xl  text-blue-100 hero-heading">redefine</h1>
